...
class Ui_Mutant(object):
    def setupUi(self, Mutant):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.valueTable.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.valueTable.setHorizontalHeaderItem(6, item)
    ...
    def retranslateUi(self, Mutant):
        ...
        item = self.valueTable.horizontalHeaderItem(5)
        item.setText(_translate("Mutant", "Row"))
        item = self.valueTable.horizontalHeaderItem(6)
        item.setText(_translate("Mutant", "Col"))
